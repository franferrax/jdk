...
public abstract class Provider extends Properties {
    ...
    */
    ...
    private static final class FIPSFilter {
        static final boolean IS_ON =
                Boolean.parseBoolean(Security.getProperty("$FIPSFilter$"));
